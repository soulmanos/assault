...
class Results:
    ...
    def __init__(self, total_time: float, requests: List[Dict]):
        ...
        )  # The lambda is the eqivalent to the function below

    # self.requests = sorted(requests, key=request_time)
    # def request_time(r):
    #     return r["request_time"]

    # The '-> ' shows us the method return type
    ...
    def average_time(self) -> float:
        ...
        )  # This list comprehension is the same as the following:
